...
memberOne = { "id" : jackson_family._generateId(),
            "firstname" :"John", 
            "lastname": jackson_family.last_name,
            "age" : 33, 
            "luckyNumbers": [7, 13, 22]}
memberTwo = { "id" : jackson_family._generateId(),
            "firstname" :"Jane", 
            "lastname": jackson_family.last_name,
            "age" : 35, 
            "luckyNumbers": [10, 14, 3]}
memberThree = { "id" : jackson_family._generateId(),
            "firstname" :"Jimmy", 
            "lastname": jackson_family.last_name,
            "age" : 5, 
            "luckyNumbers": [1]}
jackson_family.add_member(memberOne)
jackson_family.add_member(memberTwo)
jackson_family.add_member(memberThree)
...
def post_member():
    ...
    # esto no funciona porque no estamos usando ninguna BBDD -->   miembro = jackson_family.query.filter_by(id = data.get("id")).first()
    if miembro["age"] <= 0:
